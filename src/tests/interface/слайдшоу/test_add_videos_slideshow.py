...
def test_promo_add_video(clickOn, screenDiffChecker):
    ...
    assert screenDiffChecker('promo_video_slideshow.png') is None
...
def test_promo_add_two_videos(clickOn, screenDiffChecker):
    ...
    clickOn('promo_add')
    clickOn('promo_modal_yes')
    assert screenDiffChecker('promo_three_videos_slideshow.png') is None
...
def test_promo_add_all_videos(clickOn, screenDiffChecker):
    ...
    clickOn('promo_add')
    clickOn('promo_modal_yes')
    assert screenDiffChecker('promo_all_videos_slideshow.png') is None
