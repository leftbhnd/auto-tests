...
def test_connection_open(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/en_US/con_connection_open.png',
        (0, 40, 1280, 110)
    ) is None
...
def test_connection_update_modal(screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/en_US/con_connection_update_modal.png',
        (0, 40, 1280, 110)
    ) is None
...
def test_connection(screenDiffChecker):
    time.sleep(modals)
    assert screenDiffChecker(
        'localization/en_US/con_connection.png',
        (0, 40, 920, 150)
    ) is None
...
def test_connection_update(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/en_US/con_connection_update.png',
        (0, 40, 1280, 110)
    ) is None
...
def test_volume(click, screenDiffChecker, joy, node):
    ...
    assert screenDiffChecker(
        'localization/en_US/con_volume.png',
        (0, 40, 1280, 115)
    ) is None
...
def test_mic(click, screenDiffChecker, joy, node):
    ...
    node.joyCommandPub(joy_msg)
    assert screenDiffChecker(
        'localization/en_US/con_mic.png',
        (0, 40, 1280, 115)
    ) is None
...
def test_auto_mode_popup(click, screenDiffChecker):
    ...
    click(btn.handler.back)
    assert screenDiffChecker(
        'localization/en_US/con_automode_popup.png',
        (0, 40, 1280, 115)
    ) is None
...
def test_joy_mode_popup(click, typeText, screenDiffChecker):
    ...
    click(btn.handler.back)
    assert screenDiffChecker(
        'localization/en_US/con_joy_mode_popup.png',
        (0, 40, 1280, 115)
    ) is None
