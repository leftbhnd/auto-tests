...
def test_control(click, typeText, screenDiffChecker):
    ...
    click(modal.pwd.ok)
    assert screenDiffChecker(
        'localization/uk_UA/con_control.png'
    ) is None
...
def test_connection_open(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/uk_UA/con_connection_open.png',
        (0, 40, 1280, 110)
    ) is None
...
def test_connection_update_modal(screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/uk_UA/con_connection_update_modal.png',
        (0, 40, 1280, 110)
    ) is None
...
def test_connection(screenDiffChecker):
    time.sleep(modals)
    assert screenDiffChecker(
        'localization/uk_UA/con_connection.png',
        (0, 40, 920, 150)
    ) is None
...
def test_connection_wifi_pass_modal(click, screenDiffChecker):
    ...
    click(btn.handler.reset)
    assert screenDiffChecker(
        'localization/uk_UA/con_wifi_pass_modal.png',
        (365, 292, 548, 212)
    ) is None
...
def test_connection_info_modal(click, screenDiffChecker):
    ...
    time.sleep(modals)
    assert screenDiffChecker(
        'localization/uk_UA/con_connection_info_modal.png',
        (365, 292, 548, 212)
    ) is None
...
def test_connection_update(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/uk_UA/con_connection_update.png',
        (0, 40, 1280, 110)
    ) is None
...
def test_promo_open(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/uk_UA/con_promo.png',
        (0, 40, 1280, 100)
    ) is None
...
def test_add_picture_modal(click, screenDiffChecker):
    ...
    click(btn.promo.add)
    assert screenDiffChecker(
        'localization/uk_UA/con_add_picture_modal.png'
    ) is None
...
def test_added_picture(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/uk_UA/con_add_picture_slideshow.png'
    ) is None
...
def test_delete_picture_modal(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/uk_UA/con_delete_picture_modal.png'
    ) is None
...
def test_deleted_picture(click, screenDiffChecker):
    click(modal.promo.yes)
    assert screenDiffChecker(
        'localization/uk_UA/con_delete_picture_slideshow.png'
    ) is None
...
def test_printshow(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/uk_UA/con_promo_printshow.png'
    ) is None
...
def test_charge_app(click, screenDiffChecker):
    ...
    time.sleep(2)
    assert screenDiffChecker(
        'localization/uk_UA/con_charge_app.png'
    ) is None
