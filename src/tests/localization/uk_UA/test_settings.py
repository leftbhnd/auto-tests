...
def test_system_interaction(clickOn, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/uk_UA/system_interaction.png'
    ) is None
...
def test_system_menu_panel(clickOn, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/uk_UA/system_menu_panel.png'
    ) is None
...
def test_system_mic_array(clickOn, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/uk_UA/system_mic_array.png'
    ) is None
...
def test_system_reset(clickOn, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/uk_UA/system_reset.png'
    ) is None
...
def test_applications(clickOn, screenDiffChecker):
    ...
    clickOn(btn.apps)
    assert screenDiffChecker(
        'localization/uk_UA/applications.png'
    ) is None
...
def test_face_recognize(clickOn, screenDiffChecker):
    ...
    clickOn(btn.fr)
    assert screenDiffChecker(
        'localization/uk_UA/face_recognize.png'
    ) is None
...
def test_fr_facedb(clickOn, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/uk_UA/face_recognize_facedb.png'
    ) is None
...
def test_fr_adding_faces_modal(clickOn, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/uk_UA/adding_faces_modal.png'
    ) is None
...
def test_navigation(clickOn, screenDiffChecker):
    ...
    clickOn(btn.nav)
    assert screenDiffChecker(
        'localization/uk_UA/navigation.png'
    ) is None
...
def test_save_parameters(clickOn, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/uk_UA/save_parameters.png'
    ) is None
...
def test_lingvo_sources(clickOn, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/uk_UA/lingvo_sources.png'
    ) is None
...
def test_language_settings(clickOn, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/uk_UA/language_settings.png'
    ) is None
...
def test_internet_services(clickOn, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/uk_UA/internet_services.png'
    ) is None
...
def test_internet_services_sip(clickOn, screenDiffChecker):
    ...
    time.sleep(slowly)
    assert screenDiffChecker(
        'localization/uk_UA/internet_services_sip.png'
    ) is None
...
def test_internet_services_ya_disk(clickOn, screenDiffChecker):
    ...
    time.sleep(slowly)
    assert screenDiffChecker(
        'localization/uk_UA/internet_services_ya_disk.png'
    ) is None
