...
def test_con_wrong_pass_modal(click, typeText, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/fi_FI/con_wrong_pass_modal.png'
    ) is None


@pytest.mark.localization_fi_FI
def test_control(click, typeText, screenDiffChecker):
    click(modal.pwd.wr_input_fi)
    click(btn.kb.numbers)
    typeText('123456')
    click(modal.pwd.wr_ok_fi)
    assert screenDiffChecker(
        'localization/fi_FI/con_control.png'
    ) is None
...
def test_connection_wifi_pass_modal(click, screenDiffChecker):
    ...
    click(btn.handler.reset)
    assert screenDiffChecker(
        'localization/fi_FI/con_wifi_pass_modal.png',
        (365, 292, 548, 212)
    ) is None
...
def test_promo_open(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/fi_FI/con_promo.png',
        (0, 40, 1280, 100)
    ) is None
...
def test_add_picture_modal(click, screenDiffChecker):
    ...
    click(btn.promo.add)
    assert screenDiffChecker(
        'localization/fi_FI/con_add_picture_modal.png'
    ) is None
...
def test_added_picture(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/fi_FI/con_add_picture_slideshow.png'
    ) is None
...
def test_delete_picture_modal(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/fi_FI/con_delete_picture_modal.png'
    ) is None
...
def test_deleted_picture(click, screenDiffChecker):
    click(modal.promo.yes)
    assert screenDiffChecker(
        'localization/fi_FI/con_delete_picture_slideshow.png'
    ) is None
...
def test_printshow(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/fi_FI/con_promo_printshow.png'
    ) is None
...
def test_identification(click, screenDiffChecker):
    ...
    click(btn.handler.reset)
    assert screenDiffChecker(
        'localization/fi_FI/con_identification.png'
    ) is None


@pytest.mark.localization_fi_FI
def test_charge_app(click, screenDiffChecker):
    click(modal.ident.close_fi)
    click(btn.control.charge_app)
    time.sleep(2)
    assert screenDiffChecker(
        'localization/fi_FI/con_charge_app.png'
    ) is None
...
def test_phrase_mode_on(click, typeText, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/fi_FI/con_phrase_mode_on.png'
    ) is None
...
def test_phrase_mode_off(click, screenDiffChecker):
    ...
    click(btn.control.phrase_mode)
    assert screenDiffChecker(
        'localization/fi_FI/con_phrase_mode_off.png'
    ) is None
...
def test_volume(click, screenDiffChecker, joy, node):
    ...
    assert screenDiffChecker(
        'localization/fi_FI/con_volume.png'
    ) is None
...
def test_mic(click, screenDiffChecker, joy, node):
    ...
    node.joyCommandPub(joy_msg)
    assert screenDiffChecker(
        'localization/fi_FI/con_mic.png'
    ) is None
...
def test_restart_modal(click, screenDiffChecker, joy, node):
    ...
    assert screenDiffChecker(
        'localization/fi_FI/con_restart_modal.png'
    ) is None
...
def test_auto_mode_popup(click, screenDiffChecker):
    ...
    click(btn.handler.back)
    assert screenDiffChecker(
        'localization/fi_FI/con_automode_popup.png'
    ) is None
...
def test_joy_mode_popup(click, typeText, screenDiffChecker):
    ...
    click(btn.handler.back)
    assert screenDiffChecker(
        'localization/fi_FI/con_joy_mode_popup.png'
    ) is None
