...
def test_system_hardware(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/cs_CZ/set_system_hardware.png'
    ) is None
...
def test_system_led(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/cs_CZ/set_system_led.png'
    ) is None
...
def test_system_dialog(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/cs_CZ/set_system_dialog.png'
    ) is None
...
def test_save_parameters_modal(click, screenDiffChecker):
    ...
    click(btn.handler.back)
    assert screenDiffChecker(
        'localization/cs_CZ/set_save_parameters_modal.png'
    ) is None
...
def test_save_parameters_popup(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/cs_CZ/set_save_parameters_popup.png'
    ) is None
