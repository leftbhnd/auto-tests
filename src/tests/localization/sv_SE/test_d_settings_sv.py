...
def test_system_hardware(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/set_system_hardware.png'
    ) is None
...
def test_system_led(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/set_system_led.png'
    ) is None
...
def test_system_dialog(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/set_system_dialog.png'
    ) is None
...
def test_system_interaction(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/set_system_interaction.png'
    ) is None
...
def test_system_menu_panel(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/set_system_menu_panel.png'
    ) is None
...
def test_system_mic_array(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/set_system_mic_array.png'
    ) is None
...
def test_system_reset(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/set_system_reset.png'
    ) is None
...
def test_applications(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/set_applications.png'
    ) is None
...
def test_face_recognize(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/set_face_recognize.png'
    ) is None
...
def test_fr_facedb(click, screenDiffChecker):
    click(btn.fr.facedb)
    assert screenDiffChecker(
        'localization/sv_SE/set_face_recognize_facedb.png'
    ) is None
...
def test_fr_adding_faces_modal(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/set_adding_faces_modal.png'
    ) is None
...
def test_navigation(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/set_navigation.png'
    ) is None
...
def test_save_parameters_modal(click, screenDiffChecker):
    ...
    click(btn.handler.back)
    assert screenDiffChecker(
        'localization/sv_SE/set_save_parameters_modal.png'
    ) is None
...
def test_save_parameters_popup(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/set_save_parameters_popup.png'
    ) is None
...
def test_lingvo(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/set_lingvo.png'
    ) is None
...
def test_lingvo_sources(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/set_lingvo_sources.png'
    ) is None
...
def test_language_settings(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/set_language_settings.png'
    ) is None
...
def test_internet_services(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/set_internet_services.png'
    ) is None
...
def test_internet_services_sip(click, screenDiffChecker):
    ...
    time.sleep(slowly)
    assert screenDiffChecker(
        'localization/sv_SE/set_internet_services_sip.png'
    ) is None
...
def test_internet_services_ya_disk(click, screenDiffChecker):
    ...
    time.sleep(slowly)
    assert screenDiffChecker(
        'localization/sv_SE/set_internet_services_ya_disk.png'
    ) is None
...
def test_update(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/set_update.png',
        (0, 215, 1280, 585)
    ) is None
