...
def test_con_wrong_pass_modal(click, typeText, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/con_wrong_pass_modal.png'
    ) is None
...
def test_control(click, typeText, screenDiffChecker):
    ...
    click(modal.pwd.ok)
    assert screenDiffChecker(
        'localization/sv_SE/con_control.png'
    ) is None
...
def test_connection_open(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/con_connection_open.png',
        (0, 40, 1280, 110)
    ) is None
...
def test_connection_update_modal(screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/con_connection_update_modal.png',
        (0, 40, 1280, 110)
    ) is None
...
def test_connection(screenDiffChecker):
    time.sleep(modals)
    assert screenDiffChecker(
        'localization/sv_SE/con_connection.png',
        (0, 40, 800, 150)
    ) is None
...
def test_connection_wifi_pass_modal(click, screenDiffChecker):
    ...
    click(btn.handler.reset)
    assert screenDiffChecker(
        'localization/sv_SE/con_wifi_pass_modal.png',
        (365, 292, 548, 212)
    ) is None
...
def test_connection_info_modal(click, screenDiffChecker):
    ...
    time.sleep(modals)
    assert screenDiffChecker(
        'localization/sv_SE/con_connection_info_modal.png',
        (365, 292, 548, 212)
    ) is None
...
def test_connection_update(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/con_connection_update.png',
        (0, 40, 1280, 110)
    ) is None
...
def test_promo_open(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/con_promo.png',
        (0, 40, 1280, 100)
    ) is None
...
def test_add_picture_modal(click, screenDiffChecker):
    ...
    click(btn.promo.add)
    assert screenDiffChecker(
        'localization/sv_SE/con_add_picture_modal.png'
    ) is None
...
def test_delete_picture_modal(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/con_delete_picture_modal.png'
    ) is None
...
def test_deleted_picture(click, screenDiffChecker):
    click(modal.promo.yes)
    assert screenDiffChecker(
        'localization/sv_SE/con_delete_picture_slideshow.png'
    ) is None
...
def test_printshow(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/con_promo_printshow.png'
    ) is None
...
def test_identification(click, screenDiffChecker):
    ...
    click(btn.handler.reset)
    assert screenDiffChecker(
        'localization/sv_SE/con_identification.png'
    ) is None


@pytest.mark.localization_sv_SE
def test_charge_app(click, screenDiffChecker):
    click(modal.ident.close_sv)
    click(btn.control.charge_app)
    time.sleep(2)
    assert screenDiffChecker(
        'localization/sv_SE/con_charge_app.png'
    ) is None
...
def test_phrase_mode_on(click, typeText, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/con_phrase_mode_on.png'
    ) is None
...
def test_phrase_mode_off(click, screenDiffChecker):
    ...
    click(btn.control.phrase_mode)
    assert screenDiffChecker(
        'localization/sv_SE/con_phrase_mode_off.png'
    ) is None
...
def test_volume(click, screenDiffChecker, joy, node):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/con_volume.png'
    ) is None
...
def test_mic(click, screenDiffChecker, joy, node):
    ...
    node.joyCommandPub(joy_msg)
    assert screenDiffChecker(
        'localization/sv_SE/con_mic.png'
    ) is None
...
def test_restart_modal(click, screenDiffChecker, joy, node):
    ...
    assert screenDiffChecker(
        'localization/sv_SE/con_restart_modal.png'
    ) is None
...
def test_auto_mode_popup(click, screenDiffChecker):
    ...
    click(btn.handler.back)
    assert screenDiffChecker(
        'localization/sv_SE/con_automode_popup.png'
    ) is None
...
def test_joy_mode_popup(click, typeText, screenDiffChecker):
    ...
    click(btn.handler.back)
    assert screenDiffChecker(
        'localization/sv_SE/con_joy_mode_popup.png'
    ) is None
