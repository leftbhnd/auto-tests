...
def test_con_wrong_pass_modal(click, typeText, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/fr_FR/con_wrong_pass_modal.png',
        (365, 160, 545, 200)
    ) is None
...
def test_control(click, typeText, screenDiffChecker):
    ...
    click(modal.pwd.ok)
    assert screenDiffChecker(
        'localization/fr_FR/con_control.png'
    ) is None
...
def test_connection_open(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/fr_FR/con_connection_open.png',
        (0, 40, 1280, 110)
    ) is None
...
def test_connection_update_modal(screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/fr_FR/con_connection_update_modal.png',
        (0, 40, 1280, 110)
    ) is None
...
def test_connection(screenDiffChecker):
    time.sleep(modals)
    assert screenDiffChecker(
        'localization/fr_FR/con_connection.png',
        (0, 40, 920, 150)
    ) is None
...
def test_connection_wifi_pass_modal(click, screenDiffChecker):
    ...
    click(btn.handler.reset)
    assert screenDiffChecker(
        'localization/fr_FR/con_wifi_pass_modal.png',
        (365, 292, 548, 212)
    ) is None
...
def test_connection_info_modal(click, screenDiffChecker):
    ...
    time.sleep(modals)
    assert screenDiffChecker(
        'localization/fr_FR/con_connection_info_modal.png',
        (365, 292, 548, 212)
    ) is None
...
def test_connection_update(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/fr_FR/con_connection_update.png',
        (0, 40, 1280, 110)
    ) is None
...
def test_promo_open(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/fr_FR/con_promo.png',
        (0, 40, 1280, 100)
    ) is None
...
def test_add_picture_modal(click, screenDiffChecker):
    ...
    click(btn.promo.add)
    assert screenDiffChecker(
        'localization/fr_FR/con_add_picture_modal.png'
    ) is None
...
def test_added_picture(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/fr_FR/con_add_picture_slideshow.png'
    ) is None
...
def test_delete_picture_modal(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/fr_FR/con_delete_picture_modal.png'
    ) is None
...
def test_deleted_picture(click, screenDiffChecker):
    click(modal.promo.yes)
    assert screenDiffChecker(
        'localization/fr_FR/con_delete_picture_slideshow.png'
    ) is None
...
def test_printshow(click, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/fr_FR/con_promo_printshow.png'
    ) is None
...
def test_identification(click, screenDiffChecker):
    ...
    click(btn.handler.reset)
    assert screenDiffChecker(
        'localization/fr_FR/con_identification.png',
        (370, 275, 540, 240)
    ) is None
...
def test_charge_app(click, screenDiffChecker):
    ...
    time.sleep(2)
    assert screenDiffChecker(
        'localization/fr_FR/con_charge_app.png'
    ) is None
...
def test_phrase_mode_on(click, typeText, screenDiffChecker):
    ...
    assert screenDiffChecker(
        'localization/fr_FR/con_phrase_mode_on.png',
        (0, 40, 1280, 115)
    ) is None
...
def test_phrase_mode_off(click, screenDiffChecker):
    ...
    click(btn.control.phrase_mode)
    assert screenDiffChecker(
        'localization/fr_FR/con_phrase_mode_off.png',
        (0, 40, 1280, 115)
    ) is None
...
def test_volume(click, screenDiffChecker, joy, node):
    ...
    assert screenDiffChecker(
        'localization/fr_FR/con_volume.png',
        (0, 40, 1280, 115)
    ) is None
...
def test_mic(click, screenDiffChecker, joy, node):
    ...
    node.joyCommandPub(joy_msg)
    assert screenDiffChecker(
        'localization/fr_FR/con_mic.png',
        (0, 40, 1280, 115)
    ) is None
...
def test_restart_modal(click, screenDiffChecker, joy, node):
    ...
    assert screenDiffChecker(
        'localization/fr_FR/con_restart_modal.png',
        (370, 310, 540, 180)
    ) is None
...
def test_auto_mode_popup(click, screenDiffChecker):
    ...
    click(btn.handler.back)
    assert screenDiffChecker(
        'localization/fr_FR/con_automode_popup.png',
        (0, 40, 1280, 115)
    ) is None
...
def test_joy_mode_popup(click, typeText, screenDiffChecker):
    ...
    click(btn.handler.back)
    assert screenDiffChecker(
        'localization/fr_FR/con_joy_mode_popup.png',
        (0, 40, 1280, 115)
    ) is None
